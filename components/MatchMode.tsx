    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#0E1121] flex flex-col animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-4 relative overflow-hidden">
                ...
                {!isFinished ? (
                    <div
                        className="relative w-full max-w-sm aspect-[3/4] transition-all duration-300 ease-out cursor-grab active:cursor-grabbing"
                        style={{
                            ...
                            opacity: isDragging ? 1 - Math.abs(dragOffset.x) / 300 : lastDirection ? 0 : 1
                        }}
                        onTouchStart={(e) => {
                            setIsDragging(true);
